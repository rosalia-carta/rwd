$(function () {
    ...
    lorem1 =  '<h1>Title 1</h1>' + loremText + '<img src="images/img1.jpg">' + loremText;
    lorem2 =  '<h1>Title 2</h1>' + loremText + '<img src="images/img2.jpg">' + loremText + loremText;
    lorem3 =  '<h1>Title 3</h1>' + loremText + '<img src="images/img3.jpg">' + loremText;
